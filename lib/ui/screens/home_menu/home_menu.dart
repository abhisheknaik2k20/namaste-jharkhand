...
import 'package:namste_jharkhand/ui/common/controls/locale_switcher.dart';
...
import 'package:namste_jharkhand/ui/screens/home_menu/about_dialog_content.dart';
...
class _HomeMenuState extends State<HomeMenu> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: [
      AppBackdrop(strength: .5, child: Container(color: $styles.colors.greyStrong.withOpacity(.5))),
      PopNavigatorUnderlay(),
      SafeArea(
          child: Center(
              child: SizedBox(
                  width: gridWidth,
                  child: ExpandedScrollingColumn(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Gap(50),
  ...
  Widget buildRow(List<Widget> children) => SeparatedRow(
      mainAxisAlignment: MainAxisAlignment.center, separatorBuilder: () => Gap($styles.insets.sm), children: children);

  Widget _buildIconGrid(BuildContext context) =>
      SeparatedColumn(separatorBuilder: () => Gap($styles.insets.sm), mainAxisSize: MainAxisSize.min, children: [
        buildRow([
  ...
  Widget _buildBottomBtns(BuildContext context) => ValueListenableBuilder(
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: !isSelected
                ? null
                : [
                    BoxShadow(color: Colors.black.withOpacity(.3), blurRadius: 3, spreadRadius: 3, offset: Offset(0, 2))
                  ]),
        child: ClipRRect(
            borderRadius: BorderRadius.circular($styles.corners.md),
            child: AppBtn(
