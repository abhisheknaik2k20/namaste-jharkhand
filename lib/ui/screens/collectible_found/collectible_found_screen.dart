...
class CollectibleFoundScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => RepaintBoundary(
      child: _buildIntro(context).animate().swap(delay: 1050.animateMs, builder: (_, __) => _buildDetail(context)));
      ...
      Center(
          child: FractionallySizedBox(
                  ...
                  child: Hero(
                      ...
                      child: Image(image: collectible.icon, fit: BoxFit.contain)))
              .animate()
  ...
  Widget _buildDetail(BuildContext context) {
    ...
    return Stack(key: ValueKey('detail'), children: [
      AppBackdrop(strength: .5, child: Container(color: $styles.colors.greyStrong.withOpacity(.96))).animate().fadeIn(),
