...
import 'package:namste_jharkhand/ui/common/controls/eight_way_swipe_detector.dart';
import 'package:namste_jharkhand/ui/common/hidden_collectible.dart';
import 'package:namste_jharkhand/ui/common/modals/fullscreen_url_img_viewer.dart';
import 'package:namste_jharkhand/ui/common/unsplash_photo.dart';
...
class _PhotoGalleryState extends State<PhotoGallery> {
  ...
  void _handleImageFocusChanged(int index, bool isFocused) {
    if (isFocused) _setIndex(index);
  }

  bool _checkCollectibleIndex(int index) =>
      index == _getCollectibleIndex() && collectiblesLogic.isLost(widget.wonderType, 1);
