...
class _AppBar extends StatelessWidget {
  ...
  final _iconValues = const ['history.png', 'construction.png', 'geography.png'];

  ArchType _getArchType() {
    return switch (wonderType) {
      WonderType.JagannathTemple => ArchType.flatPyramid,
      WonderType.BetlaNationalPark => ArchType.wideArch,
      WonderType.ParasnathHill => ArchType.arch,
      WonderType.PatratuValley => ArchType.arch,
      WonderType.hundruFalls => ArchType.pyramid,
      WonderType.TapovanCaves => ArchType.wideArch,
      WonderType.HargaddiChokahatu => ArchType.pyramid,
      WonderType.Deoghar => ArchType.spade,
    };
  }
          ...
          children: [
            ...
            BottomCenter(
              child: ValueListenableBuilder<int>(
                ...
                builder: (_, value, __) {
                  return _CircularTitleBar(index: value, titles: _titleValues, icons: _iconValues);
                },
              ),
            ),
          ],
