...
class _BlurredImageBg extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Transform.scale(
        ...
        child: Container(
            foregroundDecoration: BoxDecoration(color: $styles.colors.black.withOpacity(fgOpacity)),
            child: settingsLogic.useBlurs
                ? ImageFiltered(imageFilter: ImageFilter.blur(sigmaX: 6, sigmaY: 6), child: img)
                : img));
  }
}
