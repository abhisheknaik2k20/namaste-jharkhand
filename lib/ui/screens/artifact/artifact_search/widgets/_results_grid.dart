...
class _ResultsGridState extends State<_ResultsGrid> {
  ...
  void _handleResultsScrolled() {
    ...
    if (vel == 0 && _prevVel == 0) FocusManager.instance.primaryFocus?.unfocus();
    _prevVel = vel ?? _prevVel;
  }

  @override
  Widget build(BuildContext context) => ScrollDecorator.shadow(
  ...
  Widget _buildLanguageMessage(BuildContext context) => ValueListenableBuilder<bool>(
      ...
      builder: (_, value, __) {
        ...
        return AppBtn.basic(
            ...
            child: Container(
                ...
                child: Row(children: [
                  Flexible(child: Text($strings.resultsPopupEnglishContent)),
                  Icon(Icons.close, size: $styles.insets.md)
                ])));
      });
}
