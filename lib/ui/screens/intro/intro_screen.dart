...
class _IntroScreenState extends State<IntroScreen> {
  ...
  Widget build(BuildContext context) {
    pageData = [
      _PageData($strings.introTitleJourney, $strings.introDescriptionNavigate, 'forest', '1'),
      _PageData($strings.introTitleExplore, $strings.introDescriptionUncover, 'landmark', '2'),
      _PageData($strings.introTitleDiscover, $strings.introDescriptionLearn, 'festival', '3'),
    ];
      ...
      children: [
        SizedBox.expand(
          child: Image.asset(
            ...
            errorBuilder: (context, error, stackTrace) => Image.asset('${ImagePaths.common}/intro-${data.img}.png',
                excludeFromSemantics: true, fit: BoxFit.cover, alignment: Alignment.centerRight),
          ),
        ),
        Positioned.fill(
            child: Image.asset(
